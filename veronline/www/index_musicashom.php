...
<body onorientationchange="Orientation();" style="background-color: #85AEE8; width: 960px;">
  <div id="meio">
    ...
    <li><a href="index_vale.php" title="Vale V�deo"><img src="../images/valevideohom.png"></a></li>
    	</ul>
      </nav>
  ...
  if (isset($_GET['index']) && isset($_GET['genx'])) {
    $index = filterBad($_GET['index']);
     //musicas
    $music = scandir('/var/www/musicas/'.$_GET['genx']);
        foreach ($music as $key => $value) {
          ...
          if ($index == $key) {
            $tem = 's';
              ...
              echo '<br/><div class="center"><b>&nbsp;Tocando: '.filterBad(ucfirst(utf8_decode($musicx))).'</b></div><br/>
...
$prox = $index+1;
echo '<br/><br/>'; 
echo '&nbsp;&nbsp;&nbsp;<a href="index_musicashom.php?index='.$anterior.'&genx='.filterBad($_GET['genx']).'"><div class="center"><b>< Anterior</b></div></a>&nbsp;&nbsp;&nbsp;
<a href="index_musicashom.php?index='.$prox.'&genx='.filterBad($_GET['genx']).'" id="nextTrack"><div class="center"><b>Pr�xima ></b></div></a>';
  } else {
  if (isset($_GET['gen'])) {
 //musicas
    $music = scandir('/var/www/musicas/'.$_GET['gen']);
        foreach ($music as $key => $value) {
          ...
          echo '<a href="index_musicashom.php?index='.$key.'&genx='.filterBad($_GET['gen']).'"><font color="#fff"><b>>> '.filterBad(utf8_decode($valuex)).'</b></font></a><br/>';
        }
