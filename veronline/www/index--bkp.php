...
document.write("<link rel=\"stylesheet\" href=\"assets/css/main3Mobile.css\" />");
				...
				<div class="inner">
						...
						<article class="box post post-excerpt">
							...
							if (isset($_GET['id'])) {
								...
								echo '<hr/>		
								<a href="play.php?id='.$_GET['id'].'&tipo=filmes">
								  <img src="midia/'.$_GET['id'].'.jpg" width="230px" height="320px" /><br><img src="play.png"/>
									...
									echo '<div class="center"><b><font color="white">'.$nomeFilme.'</font></b></div>'.$bk.'<font color="#3BA9C8">('.getEstatistica($fExploded[0]).' visualizações)</font><br /><img src="midia/'.$fExploded[0].'.jpg" style="width:180px; height: 265px">	
										</div></a>';	
									}
									}
						    ...
						    echo '<a href="index.php?opcao=shows&id='.$fExploded[0].'"><div width="200px" height="250px" style="display: inline-block; float:left; padding: 10px;">';  	
									echo '<b><font color="white">'.utf8_encode($nomeShow).'</font></b><br/>'.$bk.'<font color="#3BA9C8">('.getEstatistica($fExploded[0]).' visualizações)</font><br /><img src="midia/'.$fExploded[0].'.jpg" style="width:180px; height: 265px">	
										</div></a>';		
							}
							}
						    }
  ...
  if (isset($_GET['index']) && isset($_GET['genx'])) {
    $index = filterBad($_GET['index']);
     //musicas
    $music = scandir('./musicas/'.$_GET['genx']);
...
<a href="index.php?opcao=musicas&index='.$prox.'&genx='.filterBad($_GET['genx']).'" id="nextTrack"><div class="antprox"><b><font color="#fff">Próxima ></font></b></div></a></div>';
 ...
 //musicas
	...
	$music = scandir('./musicas/'.$_GET['gen']);
...
<div id="divSenha"> </div>
                  ...
                  ';
						    ...
						    if ($menu == 'home'){
						    	//echo '<div align="center"><img src="imgaviso.png" style="width:auto;height:auto;"></div>';
						    }
